...
export type Track = 'javascript' | 'react' | 'typescript' | 'system-design' | 'behavioral'
...
export type QuestionInput = Omit<Question, 'id' | 'viewCount' | 'solveCount' | 'createdAt' | 'updatedAt'>
...
export interface QuestionProgress {
  questionId: string
  status: 'unseen' | 'attempted' | 'solved' | 'mastered' | 'bookmarked' | 'revealed'
  attempts: number
