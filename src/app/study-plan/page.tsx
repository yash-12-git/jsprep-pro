...
interface StudyPlan {
  ...
  quickWins: string[];
  focusQuestions: string[]; // string IDs (Firestore)
}
...
export default function StudyPlanPage() {
  ...
  const readColor = (s: number) =>
    s >= 80 ? C.accent3 : s >= 60 ? C.accent2 : s >= 40 ? C.orange : C.danger;
  ...
  return (
    <>
      <div css={Shared.pageWrapper}>
        ...
        <div css={S.inputCard}>
          ...
          >
            {[
              ...
              >
                <div css={{ fontSize: "1.25rem", fontWeight: 900, color: c }}>
                  {v}
                </div>
                <div
                  css={{
        ...
        {plan && (
          <div
            css={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}
          >
            <div css={[S.section, { textAlign: "center" }]}>
              ...
              <p
                css={{ fontSize: "0.875rem", color: C.muted, lineHeight: 1.6 }}
              >
                {plan.summary}
              </p>
            </div>
            ...
            {plan.weakSpots.length > 0 && (
              <div css={[S.section, { borderColor: `${C.danger}33` }]}>
                ...
                >
                  ...
                  <h2 css={[S.sectionTitle, { color: C.danger, margin: 0 }]}>
                    Weak Spots Detected
                  </h2>
                </div>
                {plan.weakSpots.map((ws, i) => (
                  ...
                  >
                    ...
                    <p css={{ fontSize: "0.75rem", color: C.accent3 }}>
                      💡 {ws.tip}
                    </p>
                  </div>
                ))}
            ...
            <div css={[S.section, { borderColor: `${C.accent3}33` }]}>
              ...
              >
                ...
                <h2 css={[S.sectionTitle, { color: C.accent3, margin: 0 }]}>
                  Quick Wins
                </h2>
              </div>
              ...
              <div css={[S.section, { borderColor: `${C.accent}33` }]}>
                ...
                {focusQs.map((q) => (
                  ...
                  >
                    ...
                    <span css={{ fontSize: "0.75rem", color: "white" }}>
                      {q.title}
                    </span>
                  </button>
                ))}
            ...
            <div css={S.section}>
              ...
              >
                ...
                <h2 css={[S.sectionTitle, { color: C.accent2, margin: 0 }]}>
                  Daily Study Plan
                </h2>
              </div>
                ...
                >
                  ...
                  <div css={{ flex: 1 }}>
                    ...
                    >
                      ...
                      <span css={{ fontSize: "0.625rem", color: C.muted }}>
                        {day.timeMinutes} min
                      </span>
                    </div>
