...
import { getPublishedBlogPosts } from "@/lib/cachedQueries";
    ...
    <div style={{ backgroundColor: C.bg }}>
      ...
      >
        ...
        <header style={{ marginBottom: "3rem" }}>
          ...
          >
            In-depth articles on {meta.label} concepts that come up most in
        ...
        {posts.length === 0 && (
          ...
          >
            <p style={{ fontSize: "1rem" }}>No posts yet for {meta.label}.</p>
