...
import { pageMeta, articleSchema, breadcrumbSchema, faqSchema } from '@/lib/seo/seo'
...
// Very basic markdown → HTML (same lightweight parser logic)
      ...
      <div style={{ maxWidth: '52rem', margin: '0 auto', padding: '2.5rem 1.25rem', color: '#c8c8d8' }}>
        ...
        {post.content ? (
          ...
          <article className="blog-content">
            <p>Full article coming soon. In the meantime, <Link href="/dashboard" style={{ color: '#7c6af7' }}>practice in the app</Link>.</p>
          </article>
        )}
        ...
        <section style={{ background: 'rgba(124,106,247,0.08)', border: '1px solid rgba(124,106,247,0.2)', borderRadius: '1.25rem', padding: '2rem', textAlign: 'center', margin: '3rem 0' }}>
          ...
          <div style={{ display: 'flex', gap: '0.875rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/auth" style={{ padding: '0.75rem 1.5rem', background: '#7c6af7', color: 'white', borderRadius: '0.875rem', fontWeight: 800, textDecoration: 'none' }}>
              Start Free →
            </Link>
            <Link href="/javascript-interview-questions" style={{ padding: '0.75rem 1.5rem', border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.7)', borderRadius: '0.875rem', textDecoration: 'none' }}>
