              ...
              return (
                <div key={q.id} css={S.questionCard(state)}>
                  ...
                  >
                    ...
                    <div css={S.chevronWrapper(isOpen) as any}>
                    ...
                    <div css={S.cardBody}>
                      ...
                      <div css={S.inputSection}>
                        ...
                        {isLocked ? (
                          <div css={S.lockedBox}>
                            ...
                            <span css={S.lockedText}>
                              Pro feature — upgrade to attempt this question
                            </span>
                            <button
                              css={Shared.actionBtn(C.accent)}
                      ...
                      {(state === "correct" ||
                        ...
                        <div css={{ padding: "0 1.25rem 1.25rem" }}>
                          ...
                          {q.explanation && (
                            <div
                              css={[S.explanationBox, { marginTop: "0.75rem" }]}
                            >
                              <p css={S.explanationTitle(C.accent)}>
                                💡 Explanation
                              </p>
